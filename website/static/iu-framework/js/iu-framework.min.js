 ...
 */
!function(e,i,a,d){"use strict";function t(i,a,d){IU.debug("Module: Initializing IU Media - "+d,i),e(".audio audio, .video video").mediaelementplayer(a)}IU.addInitalisation("media",function(){var i=arguments[0];e(".audio, .video").length&&(loadCSS(i.assetPaths.mediaCss),e.getScript(i.assetPaths.mediaJs,function(){e(".audio audio, .video video").each(function(a){var d=e(this);if(d.data("isMediaElement"))return!0;d.data("isMediaElement",!0),new t(d,i,a)})}))}),IU.UIModule({module:"media",settings:{assetPaths:{mediaJs:"//assets.iu.edu/libs/mediaelement/mediaelement-and-player.min.js",mediaCss:"//assets.iu.edu/libs/mediaelement/mediaelementplayer.css"},audioWidth:"100%"},init:function(){IU.initialize("media",this.settings)}})}(jQuery,window,window.document);
/*!
 * IU Big Nav
 * v3.0
 ...
 * Requires: slick.js
 */
!function(e,s,t,i){"use strict";function o(s,t){IU.debug("Module: Features Carousel - "+t),s.slick({slide:".feature",infinite:!0,slidesToShow:3,slidesToScroll:1,dots:!1,responsive:[{breakpoint:860,settings:{slidesToShow:2,dots:!1}},{breakpoint:640,settings:{slidesToShow:1,centerMode:!0,centerPadding:"12px",dots:!0}}],onSetPosition:function(s){var t=this,i=e(".content",t.$slides);i.css({minHeight:""});var o=e(t.$slides[0]).find("img").height()/2;if(o)!1!==t.options.dots&&t.$dots.css({top:2*o}),t.$slider.removeClass("no-images");else{var n=i.map(function(){return e(this).find("h2").outerHeight()}).get();o=Math.max.apply(null,n)/2+50,t.$slider.addClass("no-images")}null!==t.$nextArrow&&t.$nextArrow.css({top:o}),null!==t.$prevArrow&&t.$prevArrow.css({top:o}),e(".slick-slide",t.$list).removeClass("first"),e(".slick-active:first",t.$list).addClass("first");var r=i.map(function(){return e(this).outerHeight()}).get(),a=i.map(function(){return e(this).find(".button").outerHeight()}).get(),l=Math.max.apply(null,r)+(Math.max.apply(null,a)+20);e(".slick-slide .content",t.$list).css({minHeight:l})}})}IU.addInitalisation("features-carousel",function(){e(".carousel-features").each(function(s){var t=e(this);if(t.data("isFeaturesCarousel"))return!0;t.data("isFeaturesCarousel",!0),new o(t,s)})}),IU.UIModule({module:"features-carousel",requireSlick:".carousel-features",init:function(){IU.initialize("features-carousel")}})}(jQuery,window,window.document);
/*!
 * IU Helpers
 * v3.0
 * Registers various helpers used throughout the site
 */
!function(e,t,a,n){"use strict";IU.preventHTMLScroll=function(n){if(e(a).height()>e(t).height()){var o=e("html").scrollTop()?e("html").scrollTop():e("body").scrollTop();e("html").addClass("no-scroll").css("top",-o),n&&e("html").addClass("no-scrollbar")}},IU.enableHTMLScroll=function(t){var a=parseInt(e("html").css("top"));e("html").removeClass("no-scroll"),e("html,body").scrollTop(-a),t&&e("html").removeClass("no-scrollbar")},IU.addHelper("bannerImages",function(){function t(){a.addClass("loaded"),a.css({backgroundImage:"none"})}var a=e(".banner");a.length&&(a.find(".bg-image-cover").length?a.imagesLoaded({background:".bg-image-cover"},t):a.imagesLoaded(t))}),IU.addHelper("mainHeight",function(){var t=this,a=e("#section-nav nav");a.length&&(e("main").css({minHeight:a.height()+84}),t.debug("Helper: Minimum height for <main>"))}),IU.addHelper("emailObfuscation",function(){var t=this,a=function(e){return String.fromCharCode((e<="Z"?90:122)>=(e=e.charCodeAt(0)+13)?e:e-26)};e("a[ery='absbyybj'], span[ery='absbyybj']").each(function(){var t=e(this),n=t.attr("uers").replace(/[a-zA-Z]/g,a),o=t.html(),l=void 0!==t.attr("class")?" "+t.attr("class"):"",i="email"+l;t.replaceWith("<a rel='nofollow' href='mailto:"+n+"' class='"+i+"'>"+o+"</a>")}),t.debug("Helper: Email obfuscation")}),IU.addHelper("smoothScroll",function(){var t=this;e('a[href*="#"]:not([href="#"], [href^="#panel"])').not("#skipnav a").click(function(){if(location.pathname.replace(/^\//,"")==this.pathname.replace(/^\//,"")&&location.hostname==this.hostname){var t=e(this.hash);t=t.length?t:e("[name="+this.hash.slice(1)+"]");var a=IU.settings.bigNav?68:55;if(t.length)return e("html, body").animate({scrollTop:t.offset().top-a},1e3),!1}}),t.debug("Helper: Smooth scroll")}),IU.addHelper("skipNav",function(){if(a.location.hash){var n=a.location.hash;e(n).attr("tabindex",-1).on("blur focusout",function(){e(this).removeAttr("tabindex")})}e("#skipnav a").on("click",function(t){var a=e(this.hash);if(a.length){if(e("html, body").animate({scrollTop:a.offset().top-55},500),e(a.selector).attr("tabindex",-1).on("blur focusout",function(){e(this).removeAttr("tabindex")}).focus(),"#search"===a.selector)return void e("#toggles a.search-toggle")[0].click();if("#nav-main"===a.selector&&IU.$window.width()<1025)return void e("#toggles [data-toggle]").click()}}),e(t).bind("hashchange",function(e){t.location.hash.replace(/^#/,"")})}),IU.addHelper("externalLinksInNewTabs",function(){var a=this;e("a:not(.intent, .email, .external, .selector)").each(function(){new RegExp("/"+t.location.host+"/").test(this.href)||(e(this).addClass("external"),e(this).on("click",function(e){e.stopPropagation(),e.preventDefault(),t.open(this.href,"_blank")}))}),a.debug("Helper: Open external links in new tabs")})}(jQuery,window,window.document);
/*!
 * IU Mobile Navigation
 * v3.0
 * Sets up mobile navigation: adds 'more' links, handles A11y, handles current page trails
 */
!function(e,a,n,t){"use strict";function o(){var a=e(this),n=a.closest("li.has-children"),t=a.next("ul.children");n.hasClass("open")?t.slideUp():t.slideDown(),n.toggleClass("open")}function i(){var a=e(this),n=a.text(),t=e("<a>",{href:"#",text:"More about "+n,tabindex:"-1"}).addClass("more").on("click",o);a.after(t)}IU.addInitalisation("mobile-nav",function(){IU.debug("Module: Mobile Nav");var n=e("body"),t=e(".mobile.off-canvas-list"),o=e(".off-canvas.position-right"),l=e("<a>",{href:"#",class:"extra-close-link visually-hidden",text:"Close Menu",tabindex:"-1"}).on("click",function(){e("#toggles [data-toggle]").click(),e("#toggles [data-toggle]").focus()});l.insertAfter("#off-canvas-search"),l.clone(!0).appendTo(o),o.find("a").attr("tabindex","-1"),e("[data-off-canvas]").on("opened.zf.offcanvas",function(){IU.preventHTMLScroll(!0),e("body").addClass("off-canvas-open"),e("#toggles [data-toggle]").html("&times;"),o.find("a").attr("tabindex",1),e("nav.mobile").find("a:first").focus()}),e("[data-off-canvas]").on("closed.zf.offcanvas",function(){IU.enableHTMLScroll(!0),e("body").removeClass("off-canvas-open"),e("#toggles [data-toggle]").html("Menu"),o.find("a").removeAttr("tabindex")}),e("#toggles [data-toggle]").on("click",function(e){if(e.preventDefault(),n.has("search-open"))return n.removeClass("search-open"),void o.find("a").removeAttr("tabindex")});var s=a.location.href,t=e(".mobile.off-canvas-list").first();(t.find(".current").length?t.find(".current"):t.find('a[href*="'+s+'"]').addClass("current")).parentsUntil("nav.mobile").addClass("current-trail"),t.find("li.has-children > a").each(i),t.find("li.current-trail > a.more").trigger("click"),e(a).on("resize",IU.utils.throttle(function(){e(this).width()>1024&&e(".off-canvas-wrap").hasClass("move-left")&&e(".right-off-canvas-toggle").trigger("click")},300))}),IU.UIModule({module:"mobile-nav",init:function(){IU.initialize("mobile-nav")}})}(jQuery,window,window.document);
/*!
 * IU News Ticker
 * v3.0
 ...
 * Requires: slick.js
 */
!function(i,e,s,n){"use strict";function t(e,s){IU.debug("Module: News Ticker - "+s),e.slick({slide:"li.ticker-item",infinite:!0,slidesToShow:3,slidesToScroll:1,onInit:function(e){i(".slick-slide",e.$list).each(function(){var e=i(this);0===e.find(".inner").length&&e.wrapInner('<div class="inner"></div>')})},onSetPosition:function(e){var s=this;i(".slick-slide",s.$list).removeClass("first"),i(".slick-active:first",s.$list).addClass("first");var n=i(".inner",s.$slides);n.css({minHeight:""});var t=n.map(function(){return i(this).outerHeight()}).get(),r=Math.max.apply(null,t);i(".slick-slide .inner",s.$list).css({minHeight:r})},responsive:[{breakpoint:860,settings:{slidesToShow:2}},{breakpoint:640,settings:{slidesToShow:1}}]})}IU.UIModule({module:"news-ticker",requireSlick:".ticker",init:function(){IU.initialize("news-ticker")}}),IU.addInitalisation("news-ticker",function(){i(".ticker").each(function(e){var s=i(this);if(s.data("isNewsTicker"))return!0;s.data("isNewsTicker",!0),new t(s,e)})})}(jQuery,window,window.document);
/*!
 * IU Comm Parallax
 */
 ...
 * - Social Grid Rotator
 */
!function(i,t,e,o){"use strict";function n(t,e){IU.debug("Module: Initialize ImageRotator - "+e),t.slick({slide:"figure",onInit:function(t){i(".slick-slide",t.$list).each(function(){var t=i(this);0===t.find(".img-wrap").length&&t.find("img").wrap('<div class="img-wrap"></div>')})},onSetPosition:function(t){imagesLoaded(t.$slides,function(e){var o=1e7,n=0,a=0,r=0,s=0;i.each(t.$slides,function(t){var e=i(this),r=e.find("img").css("height",""),s=e.find("figcaption"),c=r.height(),d=s.outerHeight(!0);o=c<o?c:o,n=c>n?c:n,a=d>a?d:a,r.height(o)}),r=o+a,s=o/2,t.$slideTrack.height(r),t.$slides.height(r),t.$list.height(r),t.$prevArrow.css({top:s}),t.$nextArrow.css({top:s})})}})}function a(t,e){IU.debug("Module: Initialize ItemCarousel - "+e),t.slick({slide:"article",onInit:function(t){i(".slick-slide",t.$list).each(function(){i(this).wrapInner('<div class="inner"></div>')})}})}function r(i,t){IU.debug("Module: Initialize SocialGridRotator - "+t);var e={slide:"div.item",slidesToShow:1,slidesToScroll:1,centerMode:!0,centerPadding:"24px"},o=[];enquire.register("(max-width: 23.75em)",{match:function(){o=i.slick(e)},unmatch:function(){o.unslick()}})}IU.UIModule({module:"image-rotator",requireSlick:".rotator.image",init:function(){IU.initialize("image-rotator")}}),IU.addInitalisation("image-rotator",function(){i(".rotator.image").each(function(t){var e=i(this);if(e.data("isImageRotator"))return!0;e.data("isImageRotator",!0),new n(e,t)})}),IU.UIModule({module:"item-carousel",requireSlick:"body:not(#home) .carousel",init:function(){IU.initialize("item-carousel")}}),IU.addInitalisation("item-carousel",function(){i("body:not(#home) .carousel").each(function(t){var e=i(this);if(e.data("isCarousel"))return!0;e.data("isCarousel",!0),new a(e,t)})}),IU.UIModule({module:"social-grid-rotator",requireSlick:".social-grid",init:function(){IU.initialize("social-grid-rotator")}}),IU.addInitalisation("social-grid-rotator",function(){i(".social-grid").each(function(t){var e=i(this);if(e.data("isSocialGrid"))return!0;e.data("isSocialGrid",!0),new r(e,t)})})}(jQuery,window,window.document);
/*!
 * IU Share
 * v3.0
 ...
 * - Facebook
 */
!function(e,t,n,i){"use strict";IU.addInitalisation("social-embeds",function(){e(".twitter-timeline, a.intent").length&&(t.twttr=function(e,n,i){var o,r,s=e.getElementsByTagName(n)[0];if(!e.getElementById(i))return r=e.createElement(n),r.id=i,r.src="https://platform.twitter.com/widgets.js",s.parentNode.insertBefore(r,s),t.twttr||(o={_e:[],ready:function(e){o._e.push(e)}})}(n,"script","twitter-wjs"),twttr.ready(function(e){})),e(".fb-page").length&&(e("body").append("<div id='fb-root' />"),t.fb=function(e,n,i){var o,r,s=e.getElementsByTagName(n)[0];if(!e.getElementById(i))return r=e.createElement(n),r.id=i,r.src="//connect.facebook.net/en_US/sdk.js#xfbml=1&version=v2.5",s.parentNode.insertBefore(r,s),t.fb||(o={_e:[],ready:function(e){o._e.push(e)}})}(n,"script","facebook-jssdk"),e(t).on("resize.iu.fb",function(){}))}),IU.UIModule({module:"social-embeds",init:function(){IU.initialize("social-embeds")}})}(jQuery,window,window.document);
/*!
 * IU Sticky Nav
 * v3.0
